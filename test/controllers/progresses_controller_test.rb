...
class ProgressesControllerTest < ActionController::TestCase
  ...
  test "should create progress" do
    assert_difference('Progress.count') do
      post :create, progress: { flow_id: @progress.flow_id, in_date: @progress.in_date, out_date: @progress.out_date }
    end
  ...
  test "should update progress" do
    patch :update, id: @progress, progress: { flow_id: @progress.flow_id, in_date: @progress.in_date, out_date: @progress.out_date }
    assert_redirected_to progress_path(assigns(:progress))
  end
